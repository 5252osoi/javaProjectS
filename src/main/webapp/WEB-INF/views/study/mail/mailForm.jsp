...
<div class="container">
	...
	<form name="myform" method="post">
		<table class="table table-bordered">
			<tr>
				<th>받는사람</th>
				<td><input type="text" name="toMail" value="" placeholder="수신할 메일 주소" class="form-control" required autofocus/> </td>
			</tr>
			<tr>
				<th>메일제목</th>
			...
			<tr>
				<td colspan="2" class="text-center">
					<input type="submit" value="메일쓰기" class="btn btn-success mr-2"/>
					<input type="reset" value="다시쓰기" class="btn btn-info mr-2"/>
					<input type="button" value="돌아가기" onclic="location.href='${ctp}/';" class="btn btn-warning"/>
				</td>
			</tr>
		</table>
	</form>
