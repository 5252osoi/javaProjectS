...
insert into member2 values(default,'admin','1234','관리자','관리맨','남자',default,'010-1234-1234','서울 / / /','sk204@naver.com','','학생','등산','noimage.jpg','',default,default,default,default,default,default,default,default);
...
select * from member2Chat order by idx desc limit 50;
